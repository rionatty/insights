...
import { SAPHANADataSource } from './data_source.types'
...
const database = ref<SAPHANADataSource>({
...
const fields = [
	...
	{
		label: __('Tenant Database (optional)'),
		name: 'database_name',
		type: 'text',
		placeholder: 'HDB',
	},
	{
		label: __('Schema (optional)'),
		name: 'schema',
		type: 'text',
...
<template>
	<Dialog v-model="show" :options="{ title: __('Connect to SAP HANA') }">
